...
This page is a list of Conds (Conditions) and the game they were discovered (*Yo-kai Watch 2 Conds DO NOT work in Yo-kai Watch 3*).
Conds are binary data (stored as base64 strings) which controls conditions for everything from NPCs, Quests, Trophies and even what items are available in shops!
