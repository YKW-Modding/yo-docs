...
On Citra, Azahar (formerly Lime3DS) or Azahar this can be done by:
...
Then download the latest `MyTags.txt` you can do so using [this](modding-resources/cfgbin-tags.html) guide.
