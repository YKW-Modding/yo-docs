...
Have you ever wondered what pattern Yo-kai Watch games use? Do they just use any random CRC-32 hash? No, there are actual patterns although the game dosent check for them for most IDs (meaning you dont *need to follow this for most of these*) - this is a list of the patterns for common IDs:
